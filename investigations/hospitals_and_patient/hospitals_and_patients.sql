...
SELECT  (Avg(HCAHPS_Answer_Percent_AVG * Hospital_Score_AVG) - Avg(HCAHPS_Answer_Percent_AVG) * Avg(Hospital_Score_AVG)) / (STDDEV(HCAHPS_Answer_Percent_AVG) * STDDEV(Hospital_Score_AVG)) AS Correlation_SUM_Score_Survey
